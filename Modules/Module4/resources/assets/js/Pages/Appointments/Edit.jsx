...
export default function AppointmentEdit({ appointment }) {
    const { data, setData, patch, errors, processing } = useForm({
        patient_type: appointment.patient_type || 'outpatient',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('module4.appointments.update', appointment.id));
    };
        ...
        <AuthenticatedLayout>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 min-h-screen py-12">
                <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 text-white p-6 rounded-2xl shadow-lg mb-6">
                        <h2 className="text-2xl font-bold leading-tight">Edit Appointment</h2>
                        <p className="text-cyan-100 text-sm mt-1">Modifying appointment record ID #{appointment.id}</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 border-b-4 border-cyan-500">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-4 border-t border-gray-100">
                                ...
                                <Link href={route('module4.appointments.index')} className="px-6 py-3 bg-gray-100 text-gray-600 font-semibold rounded-xl hover:bg-gray-200 transition text-center">
                                    Back
                                </Link>
                            </div>
                        </form>
