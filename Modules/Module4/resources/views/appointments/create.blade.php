    ...
    <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 min-h-screen py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-cyan-600 to-cyan-500 text-white p-6 rounded-2xl shadow-lg mb-6 flex justify-between items-center">
                <h2 class="text-2xl font-bold leading-tight">{{ __('Schedule New Appointment') }}</h2>
                <span class="bg-cyan-700 px-4 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider">{{ request('type', 'Standard') }}</span>
            </div>
                ...
                <form action="{{ route('module4.appointments.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" id="appointment_date" name="appointment_date" value="{{ old('appointment_date') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition">
                        ...
                        <div>
                            ...
                            <input type="time" id="appointment_time" name="appointment_time" value="{{ old('appointment_time') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="patient_id" name="patient_id" value="{{ old('patient_id') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition" placeholder="e.g. 104">
                        ...
                        <div>
                            ...
                            <input type="number" id="doctor_id" name="doctor_id" value="{{ old('doctor_id') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition" placeholder="e.g. 12">
                    ...
                    <div>
                        ...
                        <input type="text" id="reason_for_visit" name="reason_for_visit" value="{{ old('reason_for_visit') }}" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition" placeholder="Medical concern descriptions">
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="4" class="block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-gray-50 text-gray-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition" placeholder="Any secondary symptoms or requests...">{{ old('notes') }}</textarea>
                    ...
                    <div class="flex gap-4 pt-4 border-t border-gray-100">
                        ...
                        <a href="{{ route('module4.appointments.choose-patient-type') }}" class="px-6 py-3 bg-gray-100 text-gray-600 font-semibold rounded-xl hover:bg-gray-200 transition text-center">
                            Back
                        </a>
                    </div>
                </form>
