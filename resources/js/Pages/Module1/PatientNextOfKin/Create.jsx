...
export default function PatientNextOfKinCreate({ patients }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('patient-next-of-kin.store'));
    };

    return (
        <AuthenticatedLayout>
            <Head title="Add Patient Next of Kin" />

            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <h2 className="text-2xl font-semibold mb-6">Add Patient Next of Kin</h2>
